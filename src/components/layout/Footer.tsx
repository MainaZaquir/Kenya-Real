        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold">KenyaReal</span>
            </div>
            <p className="text-gray-400 text-sm leading-relaxed">
              Kenya's premier real estate platform, connecting buyers, sellers, and agents 
              across the country with trust, transparency, and local expertise.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Find Agents</a></li>
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Rent Calculator</a></li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Agent Guidelines</a></li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-gray-400">hello@kenyareal.co.ke</span>
              </div>
              <div className="flex items-center space-x-2">
